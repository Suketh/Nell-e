...
DEFAULT_PERSONA: dict[str, Any] = {
    ...
    "aliases": [],
    "appearance": {
        "representation": "designed digital avatar",
        "hair": "",
        "eyes": "",
        "features": "",
        "usual_expression": "",
...
def normalize_persona(raw: dict[str, Any]) -> dict[str, Any]:
    ...
    if not appearance.get("representation"):
        appearance["representation"] = "designed digital avatar"
    if not isinstance(appearance.get("style_notes"), list):
        appearance["style_notes"] = []
